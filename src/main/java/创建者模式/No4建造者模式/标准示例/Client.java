package 创建者模式.No4建造者模式.标准示例;

import 创建者模式.No4建造者模式.标准示例.产品.Bike;
import 创建者模式.No4建造者模式.标准示例.建造者.Builder;
import 创建者模式.No4建造者模式.标准示例.建造者.HelloBuilder;
import 创建者模式.No4建造者模式.标准示例.建造者.QingJuBuilder;
import 创建者模式.No4建造者模式.标准示例.指挥者.Director;
...
public class Client {
    public static void main(String[] args) {
        ...
        showBike(helloBuilder);
        showBike(qingJuBuilder);
    }
